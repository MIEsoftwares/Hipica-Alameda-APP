                ...
                >
                  ...
                  >
                    <Image
                      ...
                      source={{
                        uri: getPublicUrl("Announcement-Images", imagem),
                      }}
                    />
                  </View>
                  <View style={{ justifyContent: "space-evenly", height: 133 }}>
                    <Text
                      style={{
                        fontWeight: "bold",
                        fontSize: 18,
      ...
      >
        {loading ? (
          ...
          <>
            <Image
              style={styles.image}
              source={require("../../../assets/images/home-inicial-photo.png")}
            />
            <Text style={styles.titleWhileHasNothing}>
              Você encontrará notificações aqui
            </Text>
            <Text style={styles.subtitleWhileHasNothing}>
              Fique por dentro de atividades relevantes, como comunicados,
              agenda e notificações de eventos e aulas.
            </Text>
          </>
        ) : (
          <FlatList
